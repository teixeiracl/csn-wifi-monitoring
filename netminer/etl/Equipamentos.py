...
class Horario:
    def __init__(self,data,hora):
        self.data = data
        self.hora = hora
    def mudou(self,data, hora):
        if (self.data!=data or self.hora!=hora):
            return 1
        else:
            return 0       
    def toString(self):
...
class Equipamento:
    def __init__(self,ipRadio):
        self.ipRadio = ipRadio
        self.ipGPS = ipMap[ipRadio]
        self.nome = nomeMap[ipRadio]
        equipamentos[ipRadio]=self
    def __init__(self,ipRadio,modelo):
        self.modelo= modelo
        self.ipRadio = ipRadio
        try:
            self.ipGPS = ipMap[ipRadio]
        ...
        try:
            ...
            print("Nome do equipamento não cadastrado: "+ipRadio)
        equipamentos[ipRadio]=self
    def getIpRadio(self):
        return self.ipRadio 
    def getEquipamento(ipRadio):
        try:
            return equipamentos[ipRadio]
        except:
            novoEquipamento = Equipamento(ipRadio)
            return novoEquipamento
        
class Par:
    def __init__(self, origem:Equipamento, destino:Equipamento, rssi:int, custo:int, horario:Horario):
        self.origem = origem
...
class LogRadio:
    def __init__(self):
        self.pares = list()
        self.bestCusto = 200000
        self.bestRssi = -200
        self.bestRssiParName = ''
        self.bestCustoParName = ''
        self.coordenada = None
    def addCoordenada(self,coordenada:Coordenada):
        self.coordenada = coordenada
    def addPar(self,par:Par):
        if(par.custo < self.getMelhorCusto()):
            self.bestCusto = par.custo
            try:
                self.bestCustoParName = par.getDestino().nome
            except:
                self.bestCustoParName = ''
                print('Nome destino desconhecido')
        if(par.rssi > self.bestRssi):
            print(str(par.rssi)+" Best atual="+str(self.bestRssi))
            self.bestRssi = par.rssi
            try:
                self.bestRssiParName = par.getDestino().nome
                print ("Horario "+self.horario.toString()+"Lat:"+str(self.coordenada.lat)+" Equipamento "+self.equipamento.nome+" Par "+par.getDestino().nome+ " Melhor RSSI: "+str(self.bestRssi))
            except:
                self.bestRssiParName = ''
                print('Nome destino desconhecido')

        self.pares.append(par)
    def setHorario(self,horario:Horario):
        self.horario = horario
    def setTemperatura(self,temperatura):
        self.temperatura= temperatura
    def setEquipamento(self,equipamento:Equipamento):
        self.equipamento= equipamento
    def getHorario(self,line):
        return self.horario
    def getMelhorRssi(self):
        return self.bestRssi
        #return self.pares.sort(key=lambda x:x.rssi)[0]
    def getMelhorCusto(self):
        return self.bestCusto
        #return self.pares.sort(key=lambda x:x.custo)[0]
...
class MapaCalorPonto:
    def __init__(self,coordenada:Coordenada, horario:Horario, 
                 melhorRssi, nomeParMelhorRssi, 
                 melhorCusto, nomeParMelhorCusto) :
       self.coordenada = coordenada
       self.horario = horario 
       self.rssi  = melhorRssi
       self.nomeParMelhorRssi= nomeParMelhorRssi
       self.custo = melhorCusto
       self.nomeParMelhorCusto= nomeParMelhorCusto
#       self.equipamentoOrigem = equipamentoOrigem
#       self.equipamentoDestino = equipamentoDestino
       
class MapaCalor:
    mapaCalorPontoLista = list() # lista de equipamentos vistos nesse horário
    ...
    def getPontos(self):
        return self.mapaCalorPontoLista
...
ipMap['172.23.66.7'] = 'UFR 09 - Pires Oficina'
ipMap['172.23.66.8'] = 'UMR 40 - PCOL'
ipMap['172.23.66.9'] = 'UMR 01 - 22H ( Link )'
ipMap['172.23.66.10'] = 'UMR 27 - PCOL Banco acima'
ipMap['172.23.66.11'] = 'UMR 30 -  Salum'
ipMap['172.23.66.76'] = 'UMR 18 - Patio de Sucata'
ipMap['172.23.66.83'] = 'UMR 10 - 10N'
ipMap['172.23.66.12'] = 'UMR 31- B2 Acima rampa do ceguinho'
ipMap['172.23.66.13'] = 'UFR 02 - Britador'
ipMap['172.23.66.14'] = 'UMR 19 - ESC MINA'
ipMap['172.23.66.15'] = 'UMR 17 - 7K Prox. entrada da mina'
ipMap['172.23.66.16'] = 'UFR 06 - 13N'
ipMap['172.23.66.17'] = 'UMR 33 - Esmeril D entrada'
ipMap['172.23.66.18'] = 'UMR 16F Prox. A ES-6003'
ipMap['172.23.66.19'] = 'UMR 41 - 17 L link'
ipMap['172.23.66.20'] = 'UMR 36 - 20H Baixo'
ipMap['172.23.66.21'] = 'UMR 37 - 18N PROX ES5502'
ipMap['172.23.66.22'] = 'UMR 28 - 18D PRX 6003'
ipMap['172.23.66.23'] = 'UMR 20 - PCOL  LINK'
ipMap['172.23.66.24'] = 'UMR 35 - Vila Sub Estacão '
ipMap['172.23.66.27'] = 'UFR 07 - Sump 1080'
ipMap['172.23.66.28'] = 'UFR 08 - Pires TFI'
ipMap['172.23.66.30'] = 'UMR 39 - 18I / PCN 02'
ipMap['172.23.66.31'] = 'UMR 11 - Estrada abaixo 1080 '
ipMap['172.23.66.32'] = 'UMR 23 - Trevo 18i | Bandeira'
ipMap['172.23.66.33'] = 'UMR 32 - 8F Antigo Corpo Oeste'
ipMap['172.23.66.37'] = 'UMR 12 - 13T  LINK'
ipMap['172.23.66.41'] = 'UMR 14 - 4H Estrada sentido Batateiro'
ipMap['172.23.66.45'] = 'UMR 22 - 20H LINK Alto'
ipMap['172.23.66.46'] = 'UFR 04 - Vila 2'
ipMap['172.23.66.47'] = 'UMR 03 - Trailer telescopio  PCN'
ipMap['172.23.66.49'] = 'UMR 09 - Engenho Subida'
ipMap['172.23.66.50'] = 'UMR 04 - Trailer Telescopio Mascate'
ipMap['172.23.66.55'] = 'UMR 26- Rampa do Ceguinho'
ipMap['172.23.66.61'] = 'UMR 34 - 4H Estacionamento'
ipMap['172.23.66.63'] = 'UMR 07  -  9F'
ipMap['172.23.66.64'] = 'UMR 08 - 13T Baixo'
ipMap['172.23.66.65'] = 'UMR 24 -15K | Acima Lavador de báscula'
ipMap['172.23.66.66'] = 'UMR 29 - 23K Bandeira'
ipMap['172.23.66.67'] = 'UFR 03 - A38 Oficina LX5'
ipMap['172.23.66.199'] = 'UMR  -  Esmeril Fase 3 Alto'
ipMap['172.23.66.104'] = 'UFR CPD A38'
ipMap['172.23.66.220'] = 'RadioTabletmina'
ipMap['172.23.66.225'] = 'UMR Guarita A40'
ipMap['172.23.66.226'] = 'UMR 13 - 15F Estrada'
ipMap['172.23.66.228'] = 'UMR 25 - Entrada 16D'
ipMap['172.23.66.239'] = 'UMR 38 - 18C Praça da ES-6004'
ipMap['172.23.66.240'] = 'UMR 21 - 19'
ipMap['172.23.66.241'] = 'UFR 05 Corpo Oeste B2'
ipMap['172.23.66.242'] = 'UMR 16 - Esmeril D'
ipMap['172.23.66.243'] = 'UMR 06 - Substação 13H'
ipMap['172.23.66.244'] = 'UMR 15 - PCN1 TREVO PCOL'
...
nomeMap['172.23.66.240'] = 'UMR 21 - 19'
...
nomeMap["172.23.67.70"]="TP-8501" 
nomeMap["172.23.67.71"]="TP-8502" 
nomeMap["172.23.67.72"]="TP-8503" 
nomeMap["172.23.67.74"]="TP-8505" 
nomeMap["172.23.67.81"]="MN-2405" 
nomeMap["172.23.67.82"]="MN-2406" 
